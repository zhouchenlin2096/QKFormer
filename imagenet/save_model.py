...
def get_args_parser():
    ...
    parser.add_argument('--finetune', default='/media/data/models/qkformer-origin/output_dir_qkformer_85.65/checkpoint-203.pth',
    ...
    parser.add_argument('--output_dir', default='/media/data/models/QKFormer-github/output_dir_qkformer_85.65/',
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            misc.save_model(
                ...
                loss_scaler=loss_scaler, epoch=model_epoch)
        exit()
