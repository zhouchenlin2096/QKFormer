...
class spiking_transformer(nn.Module):
    def __init__(self,
        ...
        # patch_embed1: 提升通道:3——>embed_dims // 4
        ...
        # patch_embed2: 提升通道, embed_dims // 4 ——> embed_dims // 2; 降低fearure map： W，H ——> W/2, H/2
        ...
        # patch_embed3: 提升通, embed_dims // 2 ——> embed_dims // 1; 降低fearure map： W/2，H/2 ——> W/4, H/4
